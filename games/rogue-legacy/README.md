...
The latest option-row, full-height map-target, right-aligned proportional
loading-gate, projectile edge-marker, top-anchored death-spotlight,
pause-dimmer, and screen-local
