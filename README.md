...
| Rogue Legacy | `com.roguelegacy.port` | **Experimental:** expanded 1320×990 gameplay and touch space | Centered/animated options, full-height map/proportional gate/pause dimmer, corrected lower-left icon and death spotlights, and unobstructed map/legacy pages | 1.4.1-r2 (1) | Semantic managed-code target detection; latest screen-specific refinements await visual confirmation |
