...
| Rogue Legacy | `com.roguelegacy.port` | **Experimental:** expanded 1320×990 gameplay and touch space | Centered/animated options and runes, full-height map/gate/pause dimmer, corrected death spotlights, and unobstructed map/legacy pages | 1.4.1-r2 (1) | Semantic managed-code target detection; latest screen-specific refinements await visual confirmation |
