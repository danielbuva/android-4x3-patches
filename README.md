...
| Afterimage | `com.aurogon.Afterimage` | **Experimental:** full viewport with added vertical world coverage | Existing edge-anchored HUD retained; Android focus border disabled | 1.0.4 (50) | Guarded ARM64 camera instructions and semantic theme edit; opening gameplay checked; broader manual review pending |
...
| Hollow Knight | `com.TeamCherry.HollowKnight` | Expanded vertical camera view on separate IL2CPP and Mono port implementations | HUD/top edge, touch anchors, Mono disclaimer, centered inventory, and full-frame backdrop | IL2CPP port revision 11833; Mono port 1.3.0.0 | Runtime-selected, target-detected |
...
| Hyper Light Drifter | `com.abylight.HyperLightDrifter` | **Experimental:** 480×360 gameplay with added vertical view | Centered menus/dialogs, proportional title extensions, saved controller options, shorter startup waits | 1.1.99 (1001099), ARM64 | Exact native/data fingerprints; [verification and limitations](games/hyper-light-drifter/README.md) |
| Mega Man X Regenesis | `com.example.megamanxregenesis` | **Experimental:** 384×288 Vert+ view preserving horizontal coverage and original camera tracking | Proportional HUD, pause panel, title choices, and settings labels | 1.00.82 (manifest 1.0.0 / 1) | Semantic Godot targets; GDRE Tools 2.6.4+ required; visual testing pending |
