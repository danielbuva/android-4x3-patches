...
| Hollow Knight | `com.TeamCherry.HollowKnight` | Expanded vertical camera view on separate IL2CPP and Mono port implementations | HUD/top edge, touch anchors, Mono disclaimer, and centered inventory fit | IL2CPP port revision 11833; Mono port 1.3.0.0 | Runtime-selected, target-detected |
