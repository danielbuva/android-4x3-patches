...
| Hollow Knight | `com.TeamCherry.HollowKnight` | Expanded vertical camera view on separate IL2CPP and Mono port implementations | HUD camera/top edge, touch anchors, and Mono disclaimer fit | IL2CPP port revision 11833; Mono port 1.3.0.0 | Runtime-selected, target-detected |
