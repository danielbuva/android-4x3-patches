...
| Rogue Legacy | `com.roguelegacy.port` | **Experimental:** expanded 1320×990 gameplay and touch space | Initial metrics refresh, corrected option transitions, expanded 1220×890 map/teleporter target, and 4:3 splash/title/pause/fade layouts | 1.4.1-r2 (1) | Semantic managed-code target detection; latest map/options placement awaits visual confirmation |
