...
| Rogue Legacy | `com.roguelegacy.port` | **Experimental:** expanded 1320×990 gameplay and touch space | Jointly centered/animated option rows and parchment, full-height map/teleporter target, and 4:3 splash/title/pause/fade layouts | 1.4.1-r2 (1) | Semantic managed-code target detection; latest map/options placement awaits visual confirmation |
