...
| Rogue Legacy | `com.roguelegacy.port` | **Experimental:** expanded 1320×990 gameplay and touch space | Initial metrics refresh, corrected option transitions, centered proportional map/teleporter, and 4:3 splash/title/pause/fade layouts | 1.4.1-r2 (1) | Semantic managed-code target detection; latest map/options placement awaits visual confirmation |
...
| Streets of Rage 4 | `com.playdigious.sor4` | Vert+ gameplay with the original horizontal view | 1920×1440 HUD and pre-game roots, filler removal, centered title/menu backgrounds, bottom-aligned button legend, proportional videos | 1.4.5 (91) | Exact managed + named-GUI detection; gameplay verified, latest pre-game root placement awaits visual confirmation |
